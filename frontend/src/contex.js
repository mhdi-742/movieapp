...
const AppProvider =({children})=>{
    ...
    const delmovies=async(l)=>{
        const response=fetch("http://localhost:5000/api/del",{
          method: 'post',
          headers:{
    ...
    return <AppContext.Provider value={{movie ,isError ,isloading,SetQuery,query,search,SetSearch,fSetMovie,fmovie,fetchwatchlist,delmovies,signin,signup,fetchuser,loged,SetLoged}}>{children}</AppContext.Provider>
};
